...
const yerba = new Objeto(nombre = "Yerba", position = game.at(6, 8), frase = "¡Que rica yerba pa!", positionInventario = game.at(1,1)) 
const termo = new Objeto(nombre = "Termo",  position = game.at(17, 10), frase = "Mi compañero, siempre a mi lado", positionInventario = game.at(3,1))
const donSatur = new Objeto(nombre = "DonSatur", position = game.at(8, 15), frase = "¡Que buen bizcochito!", positionInventario = game.at(5,1))
